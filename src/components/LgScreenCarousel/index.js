...
function LgScreenCarousel() {
  ...
  const [projects] = useState([
    {
      ...
      description: (
        <>
          Collaborative project, lead the building and consumation of the{" "}
          <span className="text-sky-300 font-semibold">GraphQL API</span> and most of the app's other <span className="text-sky-300 font-semibold">functionality</span>.
          <br></br>
          EVNT is a MERN Stack event planning application for hosts to utilize.
          Users send out a survey to guests to gather data on their
          availability, budget, role in the event (bridesmaid, etc.) and more.
          Simply create an account or login, create an event, create password if
          you want the survey to be password protected, and send out the survey
          to attendees. The guests' information is stored into the database and
          their availability is displayed on a calendar. On the homepage users
          can see the schedule for all of their events. On a single event page,
          event planners can view the availability of all guests for that event.
          Click through the Nav bar to toggle between the calendar, guest data,
          your passwords for the event survey, and the survey link to send to
          guests. This SPA was built using GraphQL, MongoDB, Mongoose, Node.js,
          Express, Apollo, JWT, React, fullcalendar, CSS, and UIKit.
        </>
      ),
    ...
    },
    {
      ...
      description: (
        <>
          AWS-Thought is a{" "}
          <span className="text-sky-300 font-semibold">
            full stack AWS Cloud Application
          </span>{" "}
          where users can share their thoughts and post images. The backend API
          was built out with{" "}
          <span className="text-sky-300 font-semibold">DynamoDB</span>. Images
          are converted to URLs with{" "}
          <span className="text-sky-300 font-semibold">multer</span> and stored
          into an <span className="text-sky-300 font-semibold">S3 bucket</span>.
          The frontend is built out as a{" "}
          <span className="text-sky-300 font-semibold">React SPA</span> with a
          simple UI. The application was deployed to an{" "}
          <span className="text-sky-300 font-semibold">EC2 instance</span> by
          connecting to the SSH Client through a Virtual Machine command line,
          following best practices. Share your thoughts with the world with this
    ...
    },
    {
      ...
      description: (
        <>
          Welcome to Python Arcade! A series of algorithm-based{" "}
          <span className="text-sky-300 font-semibold">python</span> command
          line games. Begin the program by running python start.py in the root
          folder and select the game you would like to play. The current games
          offered are{" "}
          <span className="text-sky-300 font-semibold">Hangman</span>,{" "}
          <span className="text-sky-300 font-semibold">
            Rock Paper Scissors
          </span>
          , <span className="text-sky-300 font-semibold">Tic Tac Toe</span>, and{" "}
          <span className="text-sky-300 font-semibold">Minesweeper</span>, with
          more to come.
        </>
      ),
    ...
    },
    {
      ...
      description: (
        <>
          DogWorx Badgemaker is{" "}
          <span className="text-sky-300 font-semibold">C#/.NET</span>{" "}
          application where users can input information about a team including a
          link to an image, and a{" "}
          <span className="text-sky-300 font-semibold">spreadsheet</span> with
          all employee information is generated as well as an{" "}
          <span className="text-sky-300 font-semibold">
            identification badge
          </span>{" "}
          with the employee's headshot. Users may enter their own employees, or
          if the user wishes to test the application quickly, automatically
          generate employees by pulling from an API. The languages, tools, and
          frameworks used to build this application are{" "}
          <span className="text-sky-300 font-semibold">C#</span>,{" "}
          <span className="text-sky-300 font-semibold">.NET Core</span>,{" "}
          <span className="text-sky-300 font-semibold">Newtonsoft.Json</span>,
          and{" "}
          <span className="text-sky-300 font-semibold">
            .NET graphics manipulation
          </span>{" "}
          (Bitmap, System.Drawing).
        </>
      ),
      githubRepo:
        "https://github.com/garretthilberling/DogWorx-BadgeMaker-csharp",
      deployedUrl:
        "https://github.com/garretthilberling/DogWorx-BadgeMaker-csharp#Usage",
    },
    {
      name: <>Python Newsfeed</>,
      description: (
        <>
          Python Newsfeed is a social media application built as an
          implementation of a Python API. Users can create an account or login,
          create/edit/delete a post, and comment on/like the posts of other
          users. The API was built using{" "}
          <span className="text-sky-300 font-semibold">Python</span>,{" "}
          <span className="text-sky-300 font-semibold">MySQL</span>,{" "}
          <span className="text-sky-300 font-semibold">PyMySQL</span>,{" "}
          <span className="text-sky-300 font-semibold">SQLAlchemy</span> (ORM),{" "}
          <span className="text-sky-300 font-semibold">bcrypt</span> (password
          hashing), <span className="text-sky-300 font-semibold">Flask</span>,
          and <span className="text-sky-300 font-semibold">gunicorn</span>. It
          was implemented into the frontend using{" "}
          <span className="text-sky-300 font-semibold">Jinja2</span> for
          templating.
        </>
      ),
    ...
    },
    {
      ...
      description: (
        <>
          Tech News Java is a social media application built as an
          implementation of a{" "}
          <span className="text-sky-300 font-semibold">
            Java/Spring Boot API
          </span>
          . Users can create an account or login, create/edit/delete a post, and
          comment on/like the posts of other users. The API was built using{" "}
          <span className="text-sky-300 font-semibold">Java</span>,{" "}
          <span className="text-sky-300 font-semibold">MySQL</span>,{" "}
          <span className="text-sky-300 font-semibold">Spring Boot</span>, and{" "}
          <span className="text-sky-300 font-semibold">Spring Data JPA</span>.
          It was implemented into the frontend using{" "}
          <span className="text-sky-300 font-semibold">Thymeleaf</span> for
          templating.
        </>
      ),
    ...
    },
    {
      ...
      description: (
        <>
          ...
          <span className="text-sky-300 font-semibold">leadership role</span>.
          <br></br>
          Plan🌎it is a user friendly organization application where you can
          add/update/delete goals and tasks. The idea is to take someone who may
          be <span className="text-sky-300 font-semibold">
            scatterbrained
          </span>{" "}
          and{" "}
          <span className="text-sky-300 font-semibold">get them organized</span>
          . Users can input as many ideas, goals, and tasks they would like to
          accomplish, specify a category, and then Plan🌎it does the hard part
          for them: completely organizes everything in an{" "}
          <span className="text-sky-300 font-semibold">easy to understand</span>
          , <span className="text-sky-300 font-semibold">easy to manage</span>{" "}
          way. I was full stack on this project, helping build out the backend
          with GraphQL and handling all frontend queries and mutations. I also
          assisted with styling. This project is still in development!
        </>
      ),
  ...
  return (
    <Carousel>
      ...
      <div className="relative">
        <img
          src={require(`../../assets/img/apps/${11}.jpg`)}
          className="block rounded-t-lg lg:rounded-lg"
          alt="pet-fetcher"
        />
        <div className="legend lg-carousel">
          ...
          <h5 className="text-3xl text-center">{projects[11].name}</h5>
          <p
            className={`pt-2 text-center text-lg desc-align ${
              showDescription ? "block" : "hidden"
            }`}
